-- ==================================================
-- AUTO RIP INDRA (FIXED - Respawn Check Workspace មុន)
-- ==================================================
...
-- ==================================================
-- FIND RIP INDRA BOSS (Check Workspace មុនពេល Character Respawn)
-- ==================================================
local function findRipIndra()
    -- 1. ពិនិត្យ workspace មុន (Boss នៅជិត - លឿនបំផុត)
...
local function ripIndraLoop()
    ...
    while _G.YOKUDO_AutoRipIndraEnabled do
        ...
        -- ==================================================
        -- CASE 1: Boss នៅជិត (workspace) → Tween ទៅ Boss ភ្លាមៗ
        -- ==================================================
...
-- ==================================================
-- CHARACTER RESPAWN HANDLER (Check Workspace មុន)
-- ==================================================
Player.CharacterAdded:Connect(function()
    ...
    if _G.YOKUDO_AutoRipIndraEnabled then
        ...
        -- បើមិនឃើញ Boss ក្នុង workspace → បន្ត Loop ធម្មតា
        stopTweenTeleport()
    end
end)

print("✅ AutoRipIndra Loaded (Workspace Check First)")
